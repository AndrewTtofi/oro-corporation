...
export default async function TermsPage() {
  const { brandName, legalName, contactEmail, jurisdiction } = await getServerBranding();
  return (
    <LegalPage
      ...
      intro={`These Terms govern your access to and use of the ${brandName} platform and the corporate-services engagements offered through it. By creating an account or submitting an application, you agree to these Terms.`}
      sections={[
        ...
        { h: "Intellectual property", p: [`The platform, its content and software are owned by ${legalName} or its licensors. You receive a limited, non-transferable right to use the platform for your engagement.`] },
        ...
        { h: "Governing law", p: [`These Terms are governed by the laws of ${jurisdiction}, and the courts of ${jurisdiction} have exclusive jurisdiction, subject to any mandatory consumer protections that apply to you.`] },
      ]}
    />
  );
}
