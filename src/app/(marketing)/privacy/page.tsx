...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="This Policy explains how ORO Corporate Services Limited collects, uses and protects your personal data when you use the platform. We act as data controller and process data in line with the EU GDPR."
      sections={[
        ...
        { h: "Contact", p: ["For privacy questions or to exercise your rights, contact ORO Corporate Services Limited at info@oro.cy. You also have the right to lodge a complaint with the Cyprus data-protection authority."] },
      ]}
    />
  );
}
